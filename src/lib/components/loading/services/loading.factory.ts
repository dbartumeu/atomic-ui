...
import { AtLoadingComponent, LoadingType, LoadingMode, LoadingStrategy, LoadingStyle } from '../loading.component';
import { IAtLoadingConfig } from './loading.service';
...
export function LOADING_FACTORY_PROVIDER_FACTORY(
    parent: AtLoadingFactory, componentFactoryResolver: ComponentFactoryResolver, overlay: Overlay, injector: Injector): AtLoadingFactory {
