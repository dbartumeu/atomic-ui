 ...
 */
export function AtBounceAnimation(bounceOptions: IAnimationOptions = {}): AnimationTriggerMetadata {
  return trigger(bounceOptions.anchor || 'atBounce', [
    state('0', style({
