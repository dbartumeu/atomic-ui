 ...
 */
export function AtHeadshakeAnimation(headshakeOptions: IAnimationOptions = {}): AnimationTriggerMetadata {
  return trigger(headshakeOptions.anchor || 'atHeadshake', [
    state('0', style({
