...
/**
 * Function AtRotateAnimation
 *
 * params:
 * * anchor: Name of the anchor that will attach to a dom element in the components template that will contain the animation. Defaults to atRotate.
 ...
 */
export function AtRotateAnimation(rotateOptions: IRotateAnimation = {}): AnimationTriggerMetadata {
  return trigger(rotateOptions.anchor || 'atRotate', [
    state('0', style({
