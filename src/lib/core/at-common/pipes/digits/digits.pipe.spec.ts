import { AtDigitsPipe } from './digits.pipe';
...
describe('AtDigitsPipe', () => {
  let pipe: AtDigitsPipe;
  let l10nEsPipe: AtDigitsPipe;
  let l10nFrPipe: AtDigitsPipe;
  beforeEach(() => {
    pipe = new AtDigitsPipe();
    l10nEsPipe = new AtDigitsPipe('es');
    l10nFrPipe = new AtDigitsPipe('fr');
  });
