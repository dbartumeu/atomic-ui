 ...
 *
 * params:
 * * anchor: Name of the anchor that will attach to a dom element in the components template that will contain the animation. Defaults to atCollapse.
 ...
 */
export function AtCollapseAnimation(collapseOptions: ICollapseAnimation = {}): AnimationTriggerMetadata {
  return trigger(collapseOptions.anchor || 'atCollapse', [
    state('1', style({
      height: '0',
      display: 'none',
    })),
