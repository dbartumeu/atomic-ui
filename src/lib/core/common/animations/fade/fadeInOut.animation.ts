 ...
 *
 * params:
 * * anchor: Name of the anchor that will attach to a dom element in the components template that will contain the animation. Defaults to atFadeInOut
 ...
 */
export function AtFadeInOutAnimation(fadeInOut: IFadeInOutAnimation = {}): AnimationTriggerMetadata {
  return trigger((fadeInOut.anchor || 'atFadeInOut'), [
    state('0', style({
      opacity: '0',
      display: 'none',
    })),
