 ...
 */
export function AtFlashAnimation(flashOptions: IAnimationOptions = {}): AnimationTriggerMetadata {
  return trigger(flashOptions.anchor || 'atFlash', [
    state('0', style({
      opacity: 1,
    })),
    state('1',  style({
