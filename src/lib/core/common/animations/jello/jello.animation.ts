 ...
 */
export function AtJelloAnimation(jelloOptions: IAnimationOptions = {}): AnimationTriggerMetadata {
  return trigger(jelloOptions.anchor || 'atJello', [
    state('0', style({
      transform: 'none',
    })),
    state('1',  style({
