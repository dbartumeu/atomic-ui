 ...
 */
export function AtPulseAnimation(pulseOptions: IAnimationOptions = {}): AnimationTriggerMetadata {
  return trigger(pulseOptions.anchor || 'atPulse', [
    state('0', style({
