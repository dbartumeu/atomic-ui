...
import {ICanDisable, mixinDisabled} from '../../../core';

export class AtFileDropBase {}

/* tslint:disable-next-line */
export const _AtFileDropMixinBase = mixinDisabled(AtFileDropBase);

@Directive({
  selector: '[atFileDrop]',
  inputs: ['disabled'],
})
export class AtFileDropDirective extends _AtFileDropMixinBase implements ICanDisable {
