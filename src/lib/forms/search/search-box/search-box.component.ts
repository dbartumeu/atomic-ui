...
export class AtSearchBoxBase {
  constructor(public _changeDetectorRef: ChangeDetectorRef) { }
}

/* tslint:disable-next-line */
export const _AtSearchBoxMixinBase = mixinControlValueAccessor(AtSearchBoxBase);

@Component({
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => AtSearchBoxComponent),
    multi: true,
  }],
...
export class AtSearchBoxComponent extends _AtSearchBoxMixinBase implements IControlValueAccessor {
