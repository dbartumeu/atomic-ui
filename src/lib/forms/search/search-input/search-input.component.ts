...
import { IControlValueAccessor, mixinControlValueAccessor } from '../../../core';

export class AtSearchInputBase {
  constructor(public _changeDetectorRef: ChangeDetectorRef) { }
}

/* tslint:disable-next-line */
export const _AtSearchInputMixinBase = mixinControlValueAccessor(AtSearchInputBase);

@Component({
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => AtSearchInputComponent),
    multi: true,
  }],
...
export class AtSearchInputComponent extends _AtSearchInputMixinBase implements IControlValueAccessor, OnInit {
